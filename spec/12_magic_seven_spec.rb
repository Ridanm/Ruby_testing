...
require_relative '../spec/support/shared_examples_random'
...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous result is 16' do
      it 'return 12' do
        number = 16 # Arrange
  ...
  describe '#subtract_random_number' do
    context 'when the random number is 20' do
      let(:game) { MagicSeven.new(20) }
      it 'return 20' do
        expect(game.random_number).to eq(20)
      end
    end
  end
